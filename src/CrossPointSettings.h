...
class CrossPointSettings {
 ...
 public:
  ...
  // Font family options
  enum FONT_FAMILY { BOOKERLY = 0, NOTOSANS = 1, UBUNTUMONO = 2, FONT_FAMILY_COUNT };
  // Font size options
  ...
  uint8_t fadingFix = 0;
  // Night mode: inverts the display for comfortable reading in dark environments (0 = off, 1 = on)
  uint8_t nightMode = 0;
